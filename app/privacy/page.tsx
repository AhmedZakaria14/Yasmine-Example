      ...
      <div className="bg-[#00509E] text-white py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          <p className="text-lg md:text-xl text-slate-300 max-w-2xl mx-auto leading-relaxed">
            {lang === 'ar' 
              ? 'نحن في شركة خدمات الياسمين نولي أهمية كبرى لخصوصيتك وحماية بياناتك.' 
          ...
          <div className="prose prose-slate max-w-none prose-headings:text-[#00509E] prose-a:text-[#5CE1E6]">
            {lang === 'ar' ? (
              <>
                <h2>مقدمة</h2>
                <p>
                  تحترم <strong>شركة خدمات الياسمين</strong> خصوصيتك وتلتزم بحماية بياناتك الشخصية. توضح سياسة الخصوصية هذه كيف نقوم بجمع واستخدام وحماية المعلومات الخاصة بك عند زيارة موقعنا الإلكتروني أو استخدام خدماتنا.
                </p>
