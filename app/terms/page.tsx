          ...
          <div className="prose prose-slate max-w-none prose-headings:text-[#00509E] prose-a:text-[#5CE1E6]">
            {lang === 'ar' ? (
              <>
                <h2>1. قبول الشروط</h2>
                <p>
                  من خلال الوصول إلى موقع <strong>شركة الياسمين للخدمات</strong> أو استخدام خدماتنا، فإنك توافق على الالتزام بشروط الخدمة هذه وجميع القوانين واللوائح المعمول بها في المملكة العربية السعودية. إذا كنت لا توافق على أي من هذه الشروط، يُحظر عليك استخدام هذا الموقع أو خدماتنا.
                </p>
                
                <h2>2. وصف الخدمات</h2>
                <p>
                  تقدم شركة الياسمين للخدمات حلولاً متكاملة في إدارة المرافق، خدمات التنظيف الاحترافية، والضيافة للشركات والمؤسسات. تخضع جميع الخدمات للاتفاقيات والعقود المبرمة بين الشركة والعميل.
                </p>
                ...
                <p>
                  جميع المحتويات المتوفرة على هذا الموقع، بما في ذلك على سبيل المثال لا الحصر، النصوص والرسومات والشعارات والصور، هي ملك لشركة الياسمين للخدمات أو مورديها وهي محمية بموجب قوانين حقوق الطبع والنشر.
                </p>

                <h2>5. إخلاء المسؤولية</h2>
                <p>
                  يتم توفير المواد والمعلومات على موقعنا "كما هي". لا تقدم شركة الياسمين للخدمات أي ضمانات، صريحة أو ضمنية، وتنفي بموجب هذا جميع الضمانات الأخرى بما في ذلك الضمانات الضمنية أو شروط التسويق أو الملاءمة لغرض معين.
                </p>

                <h2>6. حدود المسؤولية</h2>
                <p>
                  لن تكون شركة الياسمين للخدمات في أي حال من الأحوال مسؤولة عن أي أضرار (بما في ذلك، على سبيل المثال لا الحصر، الأضرار الناجمة عن فقدان البيانات أو الأرباح، أو بسبب انقطاع الأعمال) الناشئة عن استخدام أو عدم القدرة على استخدام المواد أو الخدمات.
                </p>
