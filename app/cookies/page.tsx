          ...
          <div className="prose prose-slate max-w-none prose-headings:text-[#00509E] prose-a:text-[#5CE1E6]">
            {lang === 'ar' ? (
              <>
                ...
                <p>
                  ملفات تعريف الارتباط (Cookies) هي ملفات نصية صغيرة يتم وضعها على جهاز الكمبيوتر أو الهاتف الذكي الخاص بك عند زيارة موقعنا الإلكتروني. تستخدم <strong>شركة الياسمين للخدمات</strong> ملفات تعريف الارتباط لتحسين تجربتك وتوفير ميزات إضافية.
                </p>
